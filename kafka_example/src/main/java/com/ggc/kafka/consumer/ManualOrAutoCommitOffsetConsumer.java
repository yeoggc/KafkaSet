package com.ggc.kafka.consumer;
...
public class ManualOrAutoCommitOffsetConsumer {
    /**
     * 自动提交offset
     */
    public static void autoCommitOffset() {
        ...
        //offset的值自动提交的频率 1 提交   1.5 消费了500条数据  1.6秒宕机了  2 提交offset
    ...
    private static void manualCommitOffset() {
        /**
         手动提交offset
         如何保证spark消费kafka当中的数据 exactly  once
